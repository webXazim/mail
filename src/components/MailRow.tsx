  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <span className={`avatar avatar--${mail.color}`}>{mail.initials}{presenceOf(mail.email) !== 'offline' && <i className={`presence presence--${presenceOf(mail.email)}`} aria-label={`${presenceOf(mail.email)}`} />}</span>
