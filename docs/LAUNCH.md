...
- Stalwart TLS verifies on IMAPS 993 and SMTP submission 587.
- Shared Stalwart owns 25/587/993; CS Mail starts no second mail service.
...
- Frontend lint/typecheck/tests/build and Rust fmt/Clippy/tests/release build pass in deployment.
