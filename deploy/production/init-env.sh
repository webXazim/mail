...
echo "Web: https://mail.crescentsphere.com via Messenger's shared Docker Nginx :443"
echo "Mail protocols/PTR: smtp.crescentsphere.com (DNS-only)"
echo "Next: sudoedit $ENV_FILE, then follow deploy/production/SHARED_PROXY.md before the first deploy."
