...
describe('MailBodyFrame', () => {
  it('uses the app surface and a content-sized sandbox instead of a fixed white canvas', () => {
    ...
    expect(frame.srcdoc).toContain('background:#111817!important')
    expect(frame.style.background).toBe('rgb(17, 24, 23)')
