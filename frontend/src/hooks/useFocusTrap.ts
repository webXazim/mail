...
export function useFocusTrap(
  ...
  useEffect(() => {
    ...
    const initialElement = initialFocus ? root.querySelector<HTMLElement>(initialFocus) : undefined
    const toFocus = initialElement ?? getFocusable(root)[0]
    toFocus?.focus()
